...
filename = "traj_log_20251006_115821.pkl"
...
def calc_pro(time):
    ...
    print("the run had %d sample, with a mean of %.4f , a median of %.4f, min and max respectevely %.4f and %.4f, and a standard deviation of %.4f" % (lenght ,mean, median, Max , Min , s) )
