...
def move_and_sample(robot: "Robot", target_deg, traj_time_s: float):
    ...
    Args:
        robot: Robot instance with write_joints([...]) and get_joints_readings() in degrees.
    ...
    robot.write_joints(list(target_deg))
    ...
    while True:
        ...
        q = robot.get_joints_readings()[0]  # array of joint angles in degrees
