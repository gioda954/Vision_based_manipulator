...
A step-by-step, learning project for vision-based robotic manipulation with the OpenManipulator-X and Intel RealSense. This repository teaches the fundamentals from kinematics to a full, autonomous sorting system.
